...
python jetOutliers.py --era Run2016B $1 &
python jetOutliers.py --era Run2016C $1 &
python jetOutliers.py --era Run2016D $1 &
python jetOutliers.py --era Run2016E $1 &
python jetOutliers.py --era Run2016F $1 &
python jetOutliers.py --era Run2016G $1 &
